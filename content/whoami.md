...
[X dot com](https://x.com/sidbing) is where you'll find the most recent updates of what I'm upto in life.

## [Composio](https://composio.dev): https://github.com/composiohq/composio
- Last product I worked on was [Rube](https://rube.app).
...
- Ran evals on fine-tuned models, [Made a dataset](https://julep-ai.github.io/), that reached HN [front page](https://news.ycombinator.com/item?id=39852219) and helped clean some other datasets. First time getting my hands dirty with local llms, fine-tuning, inference, quantization, etc. 
- got much better at talking to ppl/customers and understanding what to build. social battery +10%!

## Nous (Archived): [https://github.com/noushq/](https://github.com/NousHQ/)
...
- Tried (& failed) to hit ramen profitability. I've written more about this part of my life on a [Substack](https://sidbin.substack.com/) 

## [IMDEA Research Institute](https://software.imdea.org/)

- Worked on a research hypothesis trying to test the security of third party domains and the public suffix list which describes the effective top-level domains. Went down the rabbit hole of so many papers, blogs and even old [mozilla bug threads](https://bugzilla.mozilla.org/show_bug.cgi?id=342314)!
...
## Miscellaneous stuff
- Replicated a vulnerability in Microsoft's N-RPC with a CVSS of 10. [Write Up](https://packetstorm.news/files/id/160823)
- Made an IMSI sniffer and saw all the repeating TMSI numbers around me. [[imsi-catcher]]! Also gave my first talk in front of people about software defined radio and hacking radio devices that semester. [Video](https://www.youtube.com/watch?v=44zNHfeK5b8)
- Gave a talk about container runtimes and their internals at a systems and security meetup. [Video](https://www.youtube.com/watch?v=x3X4V7g9j-0)
