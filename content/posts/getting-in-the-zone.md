...
- text someone, anyone what you need to do and how you're struggling with it. don't have to send a message, just duck debug the problem. - alternatively, talk to claude about the problem you're trying to solve - here's an example text i wrote recently.
